@extends('Admin.layouts.leftMenu') @section('title') Admin||View Prime Pertners @endsection @section('content')
<div class="page-header mt-0 p-3">
    <h3 class="mb-sm-0">View Prime Pertners</h3>
    <ol class="breadcrumb mb-0">
        <li class="breadcrumb-item">
            <a href="/"><i class="fe fe-home"></i></a>
        </li>
        <li class="breadcrumb-item active" aria-current="page">View Prime Pertners</li>
    </ol>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header">
                <h2 class="mb-0">View Prime Pertners</h2>
            </div>
            <div class="card-body">
