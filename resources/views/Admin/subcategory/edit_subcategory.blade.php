...
<div class="row">
    <div class="col-md-12">
        ...
        <form id="edit_subcategory_code" action="/edit_subcategory_action" action="#" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sub_cat_name" id="sub_cat_name" placeholder="Enter Sub-Category Nane" value="{{$event_details->sub_cat_name}}" />
                                <div class="text-danger"><strong id="sub_cat_name_error"></strong></div>
                            </div>
                        </div>
