@extends('Admin.layouts.leftMenu') @section('title') Admin||View Category @endsection @section('content')

<div class="page-header mt-0 p-3">
    <h3 class="mb-sm-0">View Category</h3>
                        ...
                        @if(isset($category_detail))
                         @foreach($category_detail as $details)
                            <tr>
                                ...
                                <td><a  href="edit_category?id={{$details->cat_id}}" class="btn btn-info mt-1 mb-1" ><i class="ion-compose"></i>&nbsp;Edit Category</a></td>
