@extends('Admin.layouts.leftMenu') @section('title') Admin||Edit Category @endsection @section('content')

<div class="page-header mt-0 p-3">
    <h3 class="mb-sm-0">Edit Category</h3>
...
<div class="row">
    <div class="col-md-12">
        ...
        <form id="edit_category_code" action="/edit_category_action" action="#" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="category_name" id="category_name" placeholder="Enter Category Nane" value="{{$event_details->cat_name}}" />
