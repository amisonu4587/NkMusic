@extends('Admin.layouts.leftMenu') @section('title') Admin||View All Payout Partner @endsection @section('content')
                            ...
                            @if (isset($events_details))
                                @foreach ($events_details as $details)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url($details->transaction_file) }}">
                                                {{ basename($details->transaction_file) }}
                                            </a>
                                        </td>
                                        <td>
                                            <a href="{{ url('/edit_payout?id=' . $details->id) }}"
                                                class="btn btn-pimary">Edit</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
