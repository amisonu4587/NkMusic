                        ...
                        @if(isset($albam_detail))
                         @foreach($albam_detail as $details)
                            <tr>
                                ...
                                <td>
                               <a  href="deletefilms?id={{$details->id}}" class="btn btn-youtube mt-1 mb-1 " ><i class="fa fa-trash"></i>Delete</a> &nbsp; 

                               <a  href="deletefilmmp3?id={{$details->id}}" class="btn btn-youtube mt-1 mb-1 " ><i class="fa fa-trash"></i>Delete MP3</a>
