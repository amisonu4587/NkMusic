								...
								<div class="col-md-12">
									<div class="card shadow">
										<div class="card-header">
											<h2 class="mb-0">View album Details</h2>
										</div>
										<div class="card-body">
											<div class="row">
                                            ...
                                            <div class="col-md-4">
												...
												<div class="col-md-4">
                                                 ...
                                                 <br><br>
                                                    <a class="btn btn-secondary mt-1 mb-1" href="/album_status?id={{$albam_detail->id}}">Add Status</a>
												...
												<div class="col-md-4">
                                                   ...
                                                   Music Release Date: {{$albam_detail->music_release_date}}/20<br>
                                                    ...
                                                    <br><br>
                                                    <a class="btn btn-secondary mt-1 mb-1" href="/add_isre?id={{$albam_detail->id}}">Add ISRE/UPC Code</a>
