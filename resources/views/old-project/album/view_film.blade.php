...
<form>        
        ...
        <div class="form-group col-md-12 row" style="margin-top: 20px;">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="star_cast" id="star_cast" value="{{$events_details->star_cast}}"  placeholder="Star Cast" readonly>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="banner_image" id="banner_image" value="{{$events_details->banner_image}}"  placeholder="Enter Film Banner" readonly>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="director" id="director" value="{{$events_details->director}}"  placeholder="Director Name" readonly>
                            <div class="text-danger"><strong id="director_error"></strong></div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="password">Producer <span style="color: red;">*</span></label>
                            <input type="text" class="form-control" name="producer" id="producer" value="{{$events_details->producer}}"  placeholder="Producer Name" readonly>
                        ...
                        <a href="/view_movie" class="btn btn-primary">Submit</a>                   
