@extends('layouts.master') @section('title','NK Music | Add Album') @section('add-css')
<style>
    .row {
        margin-right: 1px;
        margin-left: 1px;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="icon-box mb-0 p-0" style="margin-top: 20px;">
                    ...
                    {!! Form::open(['route'=>'add_song','role'=>'form','files'=>true,'id'=>'add_song_code','autocomplete' => 'off','enctype'=>'multipart/form-data']) !!} @csrf 
...
<hr>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="album_title" id="album_title" placeholder="Enter Album Title." />
                        ...
                        <div class="form-group col-md-12 row">
                           ...
                           <label for="chkYess" class="block"><input type="radio" name="religion" value="yes" onclick="myFunction3()">&nbsp;Yes</label>
                          </div>
                          <div class="col-md-4">
                       ...
                       <div class="form-group col-md-6">
                            ...
                            <option value="">-- Select Religion Category --</option>
                            @if(isset($data5))
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" class="form-control" name="audio" id="audio" placeholder="Select a mp3 file">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="text-danger"><strong id="music_release_date_error"></strong></div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="password">Premier Release Date <span style="color: red;">*</span></label>
                            <input type="date" class="form-control" name="premier_release_date" id="premier_release_date"  placeholder="Release Date" />
                            <div class="text-danger"><strong id="premier_release_date_error"></strong></div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#add_song_code").submit(function (event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success == true) {
                        ...
                        window.location.href = `/view_album?id=${response.id}`
